from PySide6.QtWidgets import QGraphicsPathItem # Importiert QGraphicsPathItem von PySide6.QtWidgets
from PySide6.QtGui import QPen, QPainterPath # Importiert QPen und QPainterPath von PySide6.QtGui
